//    
//    1. 상속
//    1) 기존 클래스(부모클래스, 슈퍼클래스)의 필드와 메서드를 새로운 클래스(자식클래스, 서브클래스)가 물려받아
//       재사용할 수 있게 해주는 객체지향 프로그래밍의 핵심 개념입니다.
...
//    2) "A는 B를 가지고 있다" 관계를 가진 클래스들도 상속 관계로 만들 수 있으나, 일반적으로 권장하지는 않습니다.(has-a 관계)
//    3) 상속 관계 예시
