 ...
 *    3) 디폴트 메소드: 자바1.8부터 default 키워드를 추가한 본문이 있는 메소드를 정의할 수 있습니다.
 *    4) 정적(static) 메소드: 자바1.8부터 static 메소드를 정의할 수 있습니다.
 * 5. 주요 특징
 *    1) 객체(인스턴스)를 생성할 수 없습니다.
 *    2) 인터페이스는 구현(implements)이라고 표현합니다. 상속 받는다고 표현하지 않습니다.
...
public interface Animal {
  ...
  static void breath() {    //정적(static) 메소드
