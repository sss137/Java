 ...
 * 2. 상속 관계를 가진 예외 처리 시에는 반드시 자식 타입의 예외를 먼저 catch 블록으로 작성해야 합니다.
 */

/*
 * java.lang.Exception
 * 1. 자바에서 예외를 처리하기 위한 최상위 클래스 중 하나입니다.(엄연히 따지면 최상위는 아닙니다.)
...
public class Main {
  ...
  public static void multiCatch() {
    ...
    try {
      ...
      System.out.println("정수값만 변환 후 누적할 수 있습니다.");       //RuntimeException 하위 예외 타입
    }
