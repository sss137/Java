...
public class Main {
  ...
  public static void method2() {
    ...
    // String Literal이란 ""로 묶은 문자열 데이터를 의미합니다.
    // String Literal은 JVM이 관리하는데 동일한 String Literal은 JVM이 기존값을 재사용합니다.
  ...
  public static void method13() {
    ...
    System.out.println(String.join(".", words));  // 문자열 배열 words의 모든 요소 사이에 "."를 추가하여 연결합니다.
