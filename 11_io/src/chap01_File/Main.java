...
public class Main {
  ...
  public static void handling() {
    ...
    //3. 디렉터리 삭제하기(있으면 삭제하는 방식으로 진행합니다.)
    if(dir.exists()) {
      dir.delete();
  ...
  public static void deleteDirectoryTree(String pathname) {     
    ...
    dir.delete();                  //최초 호출 시 "D:/2025/07/10" 경로 삭제
                                   //다음 호출 시 "D:/2025/07" 경로 삭제
                                   //다음 호출 시 "D:/2025" 경로 삭제
    
    deleteDirectoryTree(dir.getParent());     //상위 디렉터리 정보를 넘깁니다. 재귀 호출(Recursive call)
